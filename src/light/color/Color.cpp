...
int Color::run()
{
	...
	Shader object_shader("src/light/color/vertex.shader", "src/light/color/fragment.shader");
	Shader light_shader("src/light/color/vertex.shader", "src/light/color/light_fragment.shader");
	...
	glm::vec3 object_transform(0.0f, 0.0f, -3.0f);
	glm::vec3 light_transform(0.0f, 1.0f, -3.0f);


	glm::vec3 light_color(0.3f, 0.2f, 1.0f);
