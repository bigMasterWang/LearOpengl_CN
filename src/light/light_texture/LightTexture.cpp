...
// 将光照和物体的颜色的 环境颜色, 漫反射颜色 换成贴图, 镜面反射不变
int LightTexture::run()
{
	// settings
	...
	Shader object_shader("src/light/light_texture/vertex.shader", "src/light/light_texture/fragment.shader");
	Shader light_shader("src/light/light_texture/vertex.shader", "src/light/light_texture/light_fragment.shader");
